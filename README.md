...
```
This will install a the following tools.

### Commitizen
With pre-commit enforces use of Conventional Commits.  
Then after a fix, feature or breaking feature is commited it...
...
These tools can be used to ensure code passes various quallity tests before being psuhed to main branch of the github repository.  
...
## Acknowledgements
All these resources were used to create this project.  Thank you to all those who tool the time and effort to share.  
